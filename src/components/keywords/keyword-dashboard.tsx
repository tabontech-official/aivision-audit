      ...
      <div className="sticky top-[52px] z-20 -mx-4 -mt-6 sm:-mx-8 border-b border-slate-200 bg-white/95 backdrop-blur-md px-4 sm:px-8 py-2.5 shadow-2xs">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-2.5">
          <div className="flex items-center gap-2.5">
            <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-[#dff2ed] text-slate-900 shrink-0 border border-emerald-300/60">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="inline-flex items-center gap-1 rounded-md bg-[#dff2ed] px-2 py-0.5 text-[11px] font-bold text-emerald-900 font-sans border border-emerald-300">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-xl border border-slate-200 bg-white hover:bg-slate-50 text-slate-800 px-3.5 py-2 text-xs font-bold shadow-2xs transition-all cursor-pointer shrink-0 disabled:opacity-60"
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-xl bg-slate-900 hover:bg-black px-4 py-2 text-xs font-bold text-white shadow-2xs transition-colors cursor-pointer shrink-0"
            >
                      ...
                      <td className="py-3.5 px-4 text-right">
                        <div className="flex items-center justify-end gap-1.5">
                          <button
                            ...
                            className="px-2 py-1 rounded-lg bg-slate-100 hover:bg-slate-200 text-slate-700 hover:text-slate-900 font-bold text-xs flex items-center gap-1 transition-colors cursor-pointer border border-transparent hover:border-slate-300"
